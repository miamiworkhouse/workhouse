...
class ApplicantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create applicant" do
    assert_difference("Applicant.count") do
      post applicants_url, params: { applicant: { income: @applicant.income, location: @applicant.location, name: @applicant.name, problems: @applicant.problems } }
    end
  ...
  test "should update applicant" do
    patch applicant_url(@applicant), params: { applicant: { income: @applicant.income, location: @applicant.location, name: @applicant.name, problems: @applicant.problems } }
